...
import { getLocalizedText, getAllSavedAssessments, generateAssessmentId, setCurrentAssessmentId, clearAssessment, saveAssessment } from '../../utils/assessmentUtils';
import '../../poultry.css';
...
function BroilerAssessmentLanding() {
    ...
    const loadSavedAssessments = () => {
        ...
        console.log('Loaded assessments:', assessmentList);
    };

    const handleStartNewAssessment = () => {
        // Create new assessment with fresh state
        const newId = generateAssessmentId();
        console.log('Created new assessment:', newId);
        
        // Save empty assessment with new ID
    ...
    const handleContinueAssessment = (assessmentId) => {
        // Set as current assessment and navigate
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <p style={{ fontSize: '0.875rem', color: '#78350f' }}>
                                    Comprehensive assessment across 9 biosecurity categories
                                </p>
                            </div>
