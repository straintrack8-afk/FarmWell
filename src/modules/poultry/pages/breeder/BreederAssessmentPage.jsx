...
function BreederAssessmentPage() {
    ...
    const handleNext = () => {
        ...
        if (!hasNext) {
            ...
            navigate('/poultry/breeder-assessment/results');
        }
    };
                ...
                <div className="portal-card">
                    ...
                    <div style={{ padding: '1rem 2rem', background: '#f9fafb', borderBottom: '1px solid #e5e7eb' }}>
                        ...
                        <div style={{ height: '6px', background: '#e5e7eb', borderRadius: '999px', overflow: 'hidden' }}>
                            <div style={{ height: '100%', width: `${progress?.percentage || 0}%`, background: '#f59e0b', borderRadius: '999px', transition: 'width 0.3s ease' }}></div>
                        </div>
                    </div>
...
export default BreederAssessmentPage;
