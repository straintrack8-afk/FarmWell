                ...
                <div className="portal-card">
                    ...
                    <div style={{ marginBottom: '1.5rem', marginTop: '1.5rem' }}>
                        <h1 style={{ fontSize: '1.75rem', fontWeight: '800', marginBottom: '0.375rem', color: '#1e293b' }}>
                            {t('poultry.breeder.landing.title')}
                        </h1>
                        <p style={{ color: '#64748b', fontSize: '0.9375rem' }}>
                            {t('poultry.breeder.landing.subtitle')}
                        </p>
                    </div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '0.75rem', marginBottom: '1.5rem' }}>
                        ...
                        <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1rem', borderLeft: `4px solid ${accents.purple}`, boxShadow: '0 1px 4px rgba(0,0,0,0.07)', minWidth: 0, overflow: 'hidden' }}>
                            <div style={{ fontSize: '0.7rem', fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '0.4rem' }}>{t('poultry.breeder.landing.totalAssessments')}</div>
                            <div style={{ fontSize: '2rem', fontWeight: '800', color: '#1e293b', lineHeight: 1 }}>{stats.total}</div>
                            <div style={{ fontSize: '0.7rem', color: '#94a3b8', marginTop: '0.3rem' }}>{stats.completed} {t('poultry.breeder.landing.completed')}</div>
                        </div>
                        ...
                        <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1rem', borderLeft: `4px solid ${accents.green}`, boxShadow: '0 1px 4px rgba(0,0,0,0.07)', minWidth: 0, overflow: 'hidden' }}>
                            <div style={{ fontSize: '0.7rem', fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '0.4rem', lineHeight: 1.3 }}>{t('poultry.breeder.landing.lastScore')}</div>
                            ...
                            <div style={{ fontSize: '0.7rem', color: '#94a3b8', marginTop: '0.3rem' }}>{t('poultry.breeder.landing.latestCompleted')}</div>
                        </div>
                        ...
                        <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1rem', borderLeft: `4px solid ${accents.amber}`, boxShadow: '0 1px 4px rgba(0,0,0,0.07)', minWidth: 0, overflow: 'hidden' }}>
                            <div style={{ fontSize: '0.7rem', fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '0.4rem' }}>{t('poultry.breeder.landing.goodAssessments')}</div>
                            ...
                            <div style={{ fontSize: '0.7rem', color: '#94a3b8', marginTop: '0.3rem' }}>
                                {stats.completed > 0 ? Math.round((stats.goodAssessments / stats.completed) * 100) : 0}% {t('poultry.breeder.landing.ofCompleted')}
                            </div>
                        </div>
                        ...
                        <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1rem', borderLeft: `4px solid ${accents.red}`, boxShadow: '0 1px 4px rgba(0,0,0,0.07)', minWidth: 0, overflow: 'hidden' }}>
                            <div style={{ fontSize: '0.7rem', fontWeight: '600', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.04em', marginBottom: '0.4rem' }}>{t('poultry.breeder.landing.poorAssessments')}</div>
                            <div style={{ fontSize: '2rem', fontWeight: '800', color: '#EF4444', lineHeight: 1 }}>{stats.poorAssessments}</div>
                            <div style={{ fontSize: '0.7rem', color: '#94a3b8', marginTop: '0.3rem' }}>{t('poultry.breeder.landing.requiresAttention')}</div>
                        </div>
                    </div>

                    {/* Quick Actions */}
                    <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '1.25rem', boxShadow: '0 1px 4px rgba(0,0,0,0.07)' }}>
                        <h2 style={{ fontSize: '1.1rem', fontWeight: '700', marginBottom: '1rem' }}>{t('poultry.breeder.landing.quickActions')}</h2>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '0.75rem' }}>
                            <button
                                className="btn btn-primary"
                                onClick={handleStartNewAssessment}
                            >
                                {t('poultry.breeder.landing.startNewAssessment')}
                            </button>
                            <button
                                className="btn btn-primary"
                                onClick={() => {
                            ...
                            >
                                {t('poultry.breeder.landing.viewAssessmentHistory')}
                            </button>
                        </div>
                    </div>
                    ...
                    <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '1.25rem', boxShadow: '0 1px 4px rgba(0,0,0,0.07)' }} id="recent-assessments">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
                            <h2 style={{ fontSize: '1.1rem', fontWeight: '700' }}>{t('poultry.breeder.landing.recentAssessments')}</h2>
                        </div>

                        {savedAssessments.length === 0 ? (
                            <div style={{ textAlign: 'center', padding: '3rem 2rem' }}>
                                <h3 style={{ fontSize: '1.25rem', fontWeight: '700', marginBottom: '0.75rem', color: '#1e293b' }}>{t('poultry.breeder.landing.noAssessmentsYet')}</h3>
                                <p style={{ color: '#64748b', marginBottom: '1.5rem', maxWidth: '440px', margin: '0 auto 1.5rem', fontSize: '0.9rem' }}>
                                    {t('poultry.breeder.landing.noAssessmentsText')}
                                </p>
                                <button
                                    className="btn btn-primary"
                                    onClick={handleStartNewAssessment}
                                >
                                    {t('poultry.breeder.landing.startFirstAssessment')}
                                </button>
                            </div>
